...
def gen_background(item, max_retries=8):
    ...
    while retries <= max_retries:
        try:
            # 调用模型生成响应
            resp = model.call(prompt_template.format(scene_content), temperature=0.7, timeout=600)
...
if __name__ == '__main__':
    process_jsonl('/cpfs01/shared/llm_ddd/chenyongkang/DaiyuChat/data_work/data/87版红楼梦剧本_processed_by_scene_to_message_with_r1_32b_processed_by_msgs2trainingmsgs.jsonl',gen_background,max_workers=72,hard_mode=True)